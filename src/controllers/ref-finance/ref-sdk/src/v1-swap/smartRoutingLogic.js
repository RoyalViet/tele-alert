...
const ftGetTokenMetadata = require("../ref");
const checkIntegerSumOfAllocations = require("./parallelSwapLogic");
...
function getAverageFeeForRoutes(routes, nodeRoutes, totalInput) {
